                ...
                <div className="d-flex flex-row align-items-center mb-4">
                    <div className="form-outline flex-fill mb-0">
                        {errors.email ? <label role="alert" className=" text-danger form-label" htmlFor="userEmail"> Email</label> :
                            ...
                            <label className="form-label" htmlFor="userEmailLogin"> Email</label>
                        }
                        <input type="email" id="userEmailLogin" className="form-control" {...register("email", { required: "Email Address is required" })} value={dataVal.email || ""} onChange={(e) => { setDataVal({ ...dataVal, email: e.target.value }) }} />
                    </div>
                </div>
                ...
                <div className="d-flex flex-row align-items-center mb-4">
                    <div className="form-outline flex-fill mb-0">
                        {errors.password?.type === 'required' ? <label role="alert" className="form-label" htmlFor="userPassword text-danger">Password</label> :
                            <label className="form-label" htmlFor="userPasswordLogin">Password</label>

                        }
                        <input type="password" id="userPasswordLogin" className="form-control" {...register("password", { required: "Please enter password" })} value={dataVal.password || ""} onChange={(e) => { setDataVal({ ...dataVal, password: e.target.value }) }} />
